...
public class DrawFrame extends JFrame
{
    ...
    public DrawFrame()
    {
        ...
        widgetJPanel.add(Draw);
        widgetJPanel.add(Move);
        widgetJPanel.add(Resize);
        widgetJPanel.add(Copy);
         widgetJPanel.add(fill);widgetJPanel.add( Delete );
        ...
        Draw.addActionListener(buttonHandler);
        Move.addActionListener(buttonHandler);
        Resize.addActionListener(buttonHandler);
    ...
    private class ButtonHandler implements ActionListener
    {
        ...
        public void actionPerformed( ActionEvent event )
        {
            if (event.getActionCommand().equals("Undo")){
                ...
                panel.commander="Draw";
            }
            else if(event.getActionCommand().equals("Move")){
                panel.commander="Move";
            } else if(event.getActionCommand().equals("Resize")){
                panel.commander="Resize";
            }
            else if(event.getActionCommand().equals("Copy")){
                panel.commander="Copy";
            }
             else if(event.getActionCommand().equals("Fill")){
                panel.commander="Fill";
            }
            else if(event.getActionCommand().equals("Delete")){
                panel.commander="Delete";
            }
